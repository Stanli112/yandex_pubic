...
// функци€ возвращает функциональный объект,
// выполн€ющий вставку в выбранный список
template <class Type>
...
int main() {
    // main тестирует вектор, в нЄм нет ошибок.
    // не мен€йте код этой функции
    // помимо этих тестов, список должен проходить все обычные тесты списка.
    // »щите ошибки в коде списка и
    // других функци€х этого файла
